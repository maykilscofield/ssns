...
function exit2(){
    ...
    session_destroy(); // Session Silindi (Çıkış Yapıldı!)
    
    header("REFRESH:2;URL=login"); // Giriş Sayfasına Yönlendir
    echo 'You are leaving. We wait again. :)<br />'; // Çıkış Mesajı
}
...
// başlık ekle
{
    ...
    if (isset($_POST["addtitle"])) {
        $title   = strip_tags($_POST["title"], '<br><br />'); // başlık
        $content = strip_tags($_POST["content"],'<br><br />'); // açıklama
